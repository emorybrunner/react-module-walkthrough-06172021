        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Refactor the text on this page and make your own project.</li>
                    <li>This app simply scratches the surface on what is possible with React.</li>
                    <li>We3 have tried to collect the very best resources for this app, and we have cited those <Link to='/resources'>here</Link>.</li>
